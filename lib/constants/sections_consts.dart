...
final List<Map<String, dynamic>> sections = [
  ...
  },
  {
    ...
    "description":
        "إنشاء وتعديل وإدارة الدورات التدريبية مع أدوات تخطيط منهجية شاملة.",
    "route": "/courses",
  },
  {
    "icon": Icon(Icons.local_offer_outlined, color: Colors.orangeAccent),
    "title": "تصنيف الدورات", // "Courses Categorization"
    "description": "تنظيم وتصنيف الدورات لتسهيل التصفح واكتشاف المحتوى.",
  ...
  },
  {
    ...
    "description":
        "ملفات تعريف شاملة للطلاب مع متابعة التقدم وتحليلات الأداء الأكاديمي.",
    "route": "/students",
  },
  {
    "icon": Icon(Icons.group, color: Colors.blue),
    "title": "إدارة المعلمين", // "Teachers Management"
    "description": "إدارة ملفات المعلمين، تعيين الدورات، وتقييمات الأداء.",
    "route": "/teachers",
  },
  {
  ...
  },
  {
    ...
    "description": "تصميم وإدارة أقسام المنهج مع مسارات تعليمية منظمة.",
    "route": "/curriculums",
  },
  {
    "icon": Icon(Icons.military_tech, color: Colors.yellow),
    "title": "تصدير الشهادات", // "Certificate Exporting"
    "description": "إنشاء وتصدير شهادات إتمام الدورات والإنجازات.",
    "route": "/certificates",
  },
  {
